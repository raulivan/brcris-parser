...
PUBLICATION_TYPE_ARTIGO = "Artigo"
PUBLICATION_TYPE_CONFERENCIA = "Artigo de Conferência"

class ArtigoPlataformaLattes2PublicationMapper(BaseMapper):
    ...
    def transform(self, records: list[dict], validators: List[BaseValidator] = []) -> list[dict]:
        ...
        for record_string in records:
            ...
            publication_title = self.get_field_value(record, "dados_basicos__titulo_do_artigo")
            ...
            publication_alternative_title = self.get_field_value(record, "dados_basicos__titulo_do_artigo_ingles")
            ...
            publication_publicationDate = self.get_field_value(record, "dados_basicos__ano_do_artigo")
            ...
            new_journal, journal_ref = self.__transform_journal(record, journal_validator)
