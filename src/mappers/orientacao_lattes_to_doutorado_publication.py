...
class OrientacaoPlataformaLattes2DoutoradoPublicationMapper(BaseMapper):
    ...
    def transform(self, records: list[dict], logger:Logger, validators: List[BaseValidator] = []) -> list[dict]:
        ...
        for record_string in records:
            ...
            if part3 is None:
                continue
            if part3 == "ORIENTACOES-CONCLUIDAS-PARA-DOUTORADO":
            ...
            part1 = self.get_field_value(record, "dados_basicos_de_orientacoes_concluidas_para_doutorado__titulo")
            if validar_titulo(part1) == False:
                continue
            part2 = self.get_field_value(record, "dados_basicos_de_orientacoes_concluidas_para_doutorado__ano")
            if part2 is None:
                continue
            ...
            doi_fora = self.get_field_value(record, "dados_basicos_de_orientacoes_concluidas_para_doutorado__doi")
            ...
            publication_language = self.get_field_value(record, "dados_basicos_de_orientacoes_concluidas_para_doutorado__idioma")
            ...
            publication_title = self.get_field_value(record, "dados_basicos_de_orientacoes_concluidas_para_doutorado__titulo")
            ...
            publication_alternative_title = self.get_field_value(record, "dados_basicos_de_orientacoes_concluidas_para_doutorado__titulo_ingles")
            ...
            publication_publicationDate = self.get_field_value(record, "dados_basicos_de_orientacoes_concluidas_para_doutorado__ano")
            publication_fields_tupla.append(("publicationDate", trata_string(publication_publicationDate)))

            # <field name="degreeDate"/>
            publication_degreeDatee = self.get_field_value(record, "dados_basicos_de_orientacoes_concluidas_para_doutorado__ano")
            ...
            # <field name="advisor"/>
            tipo = self.get_field_value(record, "detalhamento_de_orientacoes_concluidas_para_doutorado__tipo_de_orientacao")
            ...
            publication_resourceUrl_1 = self.get_field_value(record, "dados_basicos_de_orientacoes_concluidas_para_doutorado__home_page")
    ...
    def __transform_orgunit(self, orgunit_dict: dict, validator: OrgUnitValidator = None) -> tuple[dict, str]:
        ...
        nome_instituicao = self.get_field_value(orgunit_dict, "detalhamento_de_orientacoes_concluidas_para_doutorado__nome_da_instituicao")
    ...
    def __transform_course(self, course: dict, validator: CourseValidator = None) -> tuple[dict, str]:
        ...
        # <field name="name"/>
        course_name = self.get_field_value(course, "detalhamento_de_orientacoes_concluidas_para_doutorado__nome_do_curso")
        if course_name == None:
            return None
        ...
        course_name_instituicao = self.get_field_value(course, "detalhamento_de_orientacoes_concluidas_para_doutorado__nome_da_instituicao")
        ...
        course_brcris_id_v1 = brcrisid_generator(course_name,course_name_instituicao, 'Doutorado')        
